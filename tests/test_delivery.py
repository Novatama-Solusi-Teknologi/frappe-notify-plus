...
class DeliveryTests(unittest.TestCase):
    ...
    def test_realtime_is_private_and_after_commit(self):
        ...
        doc = BaseNotification(name="LOG-1", for_user="a@test.com", custom_notification_style="Important", subject="<b>Hello</b>", document_type="ToDo", document_name="TODO-1")
        events.deliver(doc)
        args, kwargs = self.frappe.publish_realtime.call_args
        self.assertEqual(args[0], "notify_plus")
        self.assertEqual(args[1]["title"], "Hello")
        self.assertEqual(args[1]["document_type"], "ToDo")
        self.assertEqual(args[1]["document_name"], "TODO-1")
